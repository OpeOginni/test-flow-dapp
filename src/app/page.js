...
export default function Home() {
  ...
  const AuthedState = () => {
    return (
      <div>
        ...
        <button className="rounded-lg border-2 font-bold" onClick={initAccount}>
          Init Account
        </button>
        <button
  ...
  const UnauthenticatedState = () => {
    return (
      <div>
        <button className="rounded-lg border-2 font-bold" onClick={fcl.logIn}>
          Log In
        </button>
        <button className="rounded-lg border-2 font-bold" onClick={fcl.signUp}>
          Sign Up
        </button>
      </div>
    );
  ...
  return (
    <div>
      <h1 className="text-4xl font-bold pb-4">Flow App</h1>
